      ...
      <div className="input-group">
        <div className={`input-container${typeof errorNombre !== 'undefined' && errorNombre && touchedNombre ? ' error' : touchedNombre && typeof errorNombre !== 'undefined' && !errorNombre && nombre ? ' success' : ''}`}> 
          <svg className="input-icon" width="20" height="20" viewBox="0 0 24 24">
            <path fill="currentColor" d="M12 4C9.79 4 8 5.79 8 8C8 10.21 9.79 12 12 12C14.21 12 16 10.21 16 8C16 5.79 14.21 4 12 4M12 14C9.33 14 4 15.34 4 18V20H20V18C20 15.34 14.67 14 12 14Z"/>
          </svg>
          <input
            type="text"
            id="nombre"
